            ...
            <section className="slider home">
                <div className="slider-item">
                    <div className="img-slider">
                        <img className="img-item" src="/assets/images/slider/mexico-ciudad.jpg" alt="" />
                    </div>
                            ...
                            <div className="col-lg-12">
                                <div className="content po-content-two">
                                    <div className="heading">
                                        <h1 className="wow slideInDown js-letters" data-wow-delay="0ms" data-wow-duration="1200ms">Encuentra la casa de tus sueños</h1>
                                        <p className="fs-16 lh-24 text-color-2 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="2000ms"> Invierta en bienes raices de alto impacto</p>
                                        <p className="fs-16 lh-24 text-color-2 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="2000ms"> Obtenga la mejor plusvalia del caribe</p>
                                    </div>
