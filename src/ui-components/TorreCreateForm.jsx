...
export default function TorreCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setTitulodelatorre(initialValues.titulodelatorre);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Torre(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TorreCreateForm")}
      {...rest}
    >
      <TextField
