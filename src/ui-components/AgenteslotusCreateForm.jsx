...
import { createAgenteslotus } from "../graphql/mutations";
const client = generateClient();
export default function AgenteslotusCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setTipoidentificaicon(initialValues.tipoidentificaicon);
    setErrors({});
  };
  const validations = {
    Nombre: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createAgenteslotus.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "AgenteslotusCreateForm")}
      {...rest}
    >
      <TextField
        label="Nombre"
