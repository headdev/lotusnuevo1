...
export default function FraccionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setDimensionfraccion(initialValues.dimensionfraccion);
    setVendido(initialValues.vendido);
    setPreciopormetro(initialValues.preciopormetro);
    setErrors({});
  };
  const validations = {
    Titulo: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Fraccion(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "FraccionCreateForm")}
      {...rest}
    >
      <TextField
        label="Titulo"
